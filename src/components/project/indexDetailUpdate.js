                            ...
                            <div className="container-fluid text-center">
                                ...
                                <div className="form-group the-gift9 mx-auto">
                                            <textarea
                                                ...
                                                id="Textarea5"
                                                rows="1"
                                                defaultValue="Une danse de plus"
                                            >
                                            </textarea>
                                </div>
                                {/*<div className="h5-custom2 mx-auto">*/}
                                        ...
                                        <div className="position-custom position-relative">
                                            ...
                                            <div className="card p-custom6 the-gift8 mx-auto my-auto">
                                                <textarea className="form-control rounded-0 p-custom6"
                                                          id="Textarea1"
                                                          rows="12"
                                                          defaultValue="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi in laborum nobis sed voluptates. Atque cum fuga nobis quod voluptatibus.
                                                            Deleniti dolorem doloribus dolorum, nemo pariatur tempora. Inventore, iure, voluptatem.
                                                            Deleniti facilis id libero neque non obcaecati pariatur repellat totam, ullam vero! Excepturi, harum, odio. At, blanditiis earum esse est id illum quibusdam quod! Dolorem nihil nulla obcaecati porro ut.
                                                            Consectetur hic labore laudantium maiores rem similique veniam veritatis! A ad asperiores beatae deleniti doloribus, error ex explicabo laudantium magnam maiores nisi nulla odit pariatur quo reiciendis, unde vitae voluptate. Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                            Aut cupiditate et eveniet impedit, inventore ipsam magni minus molestiae officia perspiciatis porro quibusdam. Autem id in, molestiae neque omnis reiciendis sit! Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                            Beatae consequuntur cum deleniti dicta eius eos, eum eveniet excepturi id in iusto nobis numquam omnis optio perspiciatis reiciendis, repellat ut velit."
                                                >
